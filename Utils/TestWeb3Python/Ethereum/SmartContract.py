...
from Utils import setConfig, loadConfig, hash_to_bytes32, getContractAddress
...
class Contract:
    def __init__(self, config):
        self.web3 = Web3(Web3.HTTPProvider(config["host"]))
    ...
    def startTransaction(self, tx):
        ...
        self.web3.geth.personal.unlock_account(self.public_address, self.psw)
...
if __name__ == "__main__":
    ...
    print(AirFactories2.getPrintingInfo("prova4"))
